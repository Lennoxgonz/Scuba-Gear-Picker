    ...
    <>
        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="text-center text-md-start">
              ...
              <p className="lead">
                Customize and compare diving equipment to create your ideal
                setup
              </p>
        ...
        <Row>
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm">
              <Card.Img
                variant="top"
                src={diveMaskImg}
                alt="Picture of a diving mask"
              />
              <Card.Body>
                <Card.Title>Diving Masks</Card.Title>
                <Card.Text>
                  Explore our selection of high-quality diving masks for optimal
                  visibility.
                </Card.Text>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm">
              <Card.Img
                variant="top"
                src={diveRegulatorImg}
                alt="Picture of a diving regulator"
              />
              <Card.Body>
                <Card.Title>Regulators</Card.Title>
                <Card.Text>
                  Find the perfect regulator for your diving needs and
                  experience level.
                </Card.Text>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm">
              <Card.Img
                variant="top"
                src={diveComputerImg}
                alt="Picture of a dive computer"
              />
              <Card.Body>
                <Card.Title>Dive Computers</Card.Title>
                <Card.Text>
                  Stay safe with our advanced dive computers and monitoring
                  systems.
                </Card.Text>
          ...
          <Row className="g-4">
            <Col md={4} className="text-center">
              <div className="p-3">
                ...
                <p>
                  Create the perfect combination of gear tailored to your needs
                </p>
              </div>
            </Col>
            <Col md={4} className="text-center">
            ...
            <Col md={4} className="text-center">
              <div className="p-3">
                ...
                <p>
                  Get guidance from experienced divers and equipment specialists
                </p>
              </div>
            </Col>
          </Row>
      ...
      <Container fluid className="home-footer text-white text-center py-5">
        ...
        <p className="lead mb-4">
          Start customizing your perfect diving equipment setup today
        </p>
